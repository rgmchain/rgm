...
const char * const BITCOIN_CONF_FILENAME = "rgm.conf";
const char * const BITCOIN_PID_FILENAME = "rgmd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "RGM";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/RGM";
#else
    // Unix
    return pathRet / ".rgm";
#endif
