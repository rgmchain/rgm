...
const QMetaObject PeerTools::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PeerTools.data,
      qt_meta_data_PeerTools,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PeerTools::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PeerTools.stringdata0))
        return static_cast<void*>(const_cast< PeerTools*>(this));
...
void AddPeerDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AddPeerDialog *_t = static_cast<AddPeerDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AddPeerDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddPeerDialog.data,
      qt_meta_data_AddPeerDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AddPeerDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddPeerDialog.stringdata0))
        return static_cast<void*>(const_cast< AddPeerDialog*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TestPeerDialog *_t = static_cast<TestPeerDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject TestPeerDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TestPeerDialog.data,
      qt_meta_data_TestPeerDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TestPeerDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestPeerDialog.stringdata0))
        return static_cast<void*>(const_cast< TestPeerDialog*>(this));
    return QWidget::qt_metacast(_clname);
}
