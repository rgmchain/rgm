...
#ifndef RGM_QT_BITCOINUNITS_H
#define RGM_QT_BITCOINUNITS_H
...
*/
class RgmUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RgmUnits(QObject *parent);
...
typedef RgmUnits::Unit BitcoinUnit;
