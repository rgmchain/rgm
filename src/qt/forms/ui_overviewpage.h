...
public:
    ...
    QGridLayout *logo_grid;
    QLabel *label_wallet_bgcoin;
    QLabel *label_wallet_version_overlay;
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelWatchPending->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 DOGE"));
        ...
        labelUnconfirmed->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 DOGE"));
        ...
        labelWatchImmature->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 DOGE"));
        ...
        labelImmature->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 DOGE"));
        ...
        labelTotal->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 DOGE"));
        ...
        labelWatchTotal->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 DOGE"));
        ...
        labelBalance->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 DOGE"));
        ...
        labelWatchAvailable->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 DOGE"));
        ...
        logo_grid = new QGridLayout();
        logo_grid->setObjectName(QStringLiteral("logo_grid"));
        label_wallet_bgcoin = new QLabel(OverviewPage);
        label_wallet_bgcoin->setObjectName(QStringLiteral("label_wallet_bgcoin"));
        label_wallet_bgcoin->setPixmap(QPixmap(QString::fromUtf8(":/icons/wallet_bgcoin")));
        ...
        logo_grid->addWidget(label_wallet_bgcoin, 0, 0, 1, 1);

        label_wallet_version_overlay = new QLabel(OverviewPage);
        label_wallet_version_overlay->setObjectName(QStringLiteral("label_wallet_version_overlay"));
        label_wallet_version_overlay->setScaledContents(false);
        label_wallet_version_overlay->setAlignment(Qt::AlignLeft|Qt::AlignBottom);
        label_wallet_version_overlay->setMargin(2);

        logo_grid->addWidget(label_wallet_version_overlay, 0, 0, 1, 1);


        verticalLayout_2->addLayout(logo_grid);
        ...
        label_tip_header = new QLabel(OverviewPage);
        label_tip_header->setObjectName(QStringLiteral("label_tip_header"));
        label_tip_header->setFont(font);

        verticalLayout_5->addWidget(label_tip_header);

        label_tip = new QLabel(OverviewPage);
        label_tip->setObjectName(QStringLiteral("label_tip"));

        verticalLayout_5->addWidget(label_tip);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the RGM network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        label_wallet_version_overlay->setText(QString());
        label_4->setText(QApplication::translate("OverviewPage", "Recent transactions", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the RGM network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelTransactionsStatus->setText(QString());
        label_tip_header->setText(QApplication::translate("OverviewPage", "Helpful tip of the day:", Q_NULLPTR));
        label_tip->setText(QApplication::translate("OverviewPage", "Tip", Q_NULLPTR));
    } // retranslateUi
