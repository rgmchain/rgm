...
public:
    ...
    QLabel *label_5;
    QLabel *labelAddressType;
    QComboBox *addressType;
    QLabel *label_2;
    QLabel *label;
    RgmAmountField *reqAmount;
    ...
    void setupUi(QWidget *ReceiveCoinsDialog)
    {
        ...
        labelAddressType = new QLabel(frame2);
        labelAddressType->setObjectName(QStringLiteral("labelAddressType"));
        labelAddressType->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout->addWidget(labelAddressType, 3, 0, 1, 1);

        addressType = new QComboBox(frame2);
        addressType->setObjectName(QStringLiteral("addressType"));

        gridLayout->addWidget(addressType, 3, 2, 1, 1);
        ...
        reqAmount = new RgmAmountField(frame2);
        ...
        labelAddressType->setBuddy(addressType);
        label_2->setBuddy(reqLabel);
        label->setBuddy(reqAmount);
#endif // QT_NO_SHORTCUT
        QWidget::setTabOrder(addressType, reqLabel);
...
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the RGM network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        reqMessage->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the RGM network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelAddressType->setToolTip(QApplication::translate("ReceiveCoinsDialog", "Choose the type of receiving address to generate.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelAddressType->setText(QApplication::translate("ReceiveCoinsDialog", "Address &type:", Q_NULLPTR));
        addressType->clear();
        addressType->insertItems(0, QStringList()
         << QApplication::translate("ReceiveCoinsDialog", "Legacy (R...)", Q_NULLPTR)
         << QApplication::translate("ReceiveCoinsDialog", "Bech32 (native SegWit)", Q_NULLPTR)
        );
#ifndef QT_NO_TOOLTIP
        addressType->setToolTip(QApplication::translate("ReceiveCoinsDialog", "Legacy (R...) \342\200\224 original address format, works on all nodes.\n"
"Bech32 (native SegWit) \342\200\224 lowest fees, requires SegWit activation.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
