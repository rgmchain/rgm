...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payAmount = new RgmAmountField(SendCoins);
        ...
        payAmount_is = new RgmAmountField(SendCoins_UnauthenticatedPaymentRequest);
        ...
        payAmount_s = new RgmAmountField(SendCoins_AuthenticatedPaymentRequest);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The RGM address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less rgm than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the dogecoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the RGM network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
