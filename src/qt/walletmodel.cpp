...
// Copyright (c) 2020-2022 The RGM Core developers
...
{
    // Accepts legacy (R...), P2SH (r...), and bech32 (rgm1...) addresses.
...
bool WalletModel::isMine(const CTxDestination& dest) const
{
    LOCK(wallet->cs_wallet);
    return ::IsMine(*wallet, dest) != ISMINE_NO;
}
