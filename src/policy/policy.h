...
#ifndef RGM_POLICY_POLICY_H
#define RGM_POLICY_POLICY_H
...
/** Recommended transaction fee by RGM Core developers
  *
 ...
 *
 *  RGM:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * RGM: Default dust limit that is evaluated when considering whether a
...
/**
 * RGM: Default hard dust limit that is evaluated when considering whether
