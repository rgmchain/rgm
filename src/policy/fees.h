...
// Copyright (c) 2023 The RGM Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
#ifndef RGM_POLICYESTIMATOR_H
#define RGM_POLICYESTIMATOR_H
 ...
 * RGM miners have a hightened incentive to not orphan blocks while the
